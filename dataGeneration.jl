...
function generateTimeSeries(communitySize,Tmax;Tmean=0,Tamp=5,τ=20,σtrait=8,μmax=1,m=1,Rtot=1000,im=0,traitRange=10)
    ...
    return Float32.([sol.u[i][j] for i in 1:Tmax,j in 1:communitySize])
end